...
// To make clangd's preamble end so it can process the pragma commands correctly in my IDE.
int dummy_decl(void);
...
FUNCTION_DEF_VOID(i8,  int i0, int i1, int i2, int i3, int i4, int i5, int i6, int i7)
FUNCTION_DEF_VOID(i9,  int i0, int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8)
FUNCTION_DEF_VOID(i10, int i0, int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9)
...
#define FUNCTIONCALL_MEASURE(SPEC, ...) int functioncall_measure_ ## SPEC (void) { \
	unsigned long long start, end; \
    unsigned int tsc_aux; \
    start = __rdtscp(&tsc_aux); \
    _mm_lfence(); \
...
static int (*int_measure_ptr[FNCALL_INT_ARGS_MAX + 1])(void) = {
	functioncall_measure_v_v,
	functioncall_measure_v_i1, 
	functioncall_measure_v_i2, 
	functioncall_measure_v_i3, 
	functioncall_measure_v_i4, 
	functioncall_measure_v_i5, 
	functioncall_measure_v_i6, 
	functioncall_measure_v_i7, 
	functioncall_measure_v_i8, 
	functioncall_measure_v_i9, 
	functioncall_measure_v_i10
};

functioncall_results functioncall_measure_all(int runs) {
	functioncall_results f;
	f.calibration = functioncall_measure_multi(functioncall_measure_nothing, runs);
